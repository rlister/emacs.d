...
;; (setq mu4e-headers-fields '((:human-date . 12) (:flags . 6) (:mailing-list . 10) (:from . 22)
;;  (:subject)))
...
(setq mu4e-contexts
      `(,(make-mu4e-context
          ...
          :vars '((user-mail-address . "rlister@gmail.com"  )
                  ...
                  (mu4e-maildir-shortcuts . ((:maildir "/home/inbox" :key ?i) (:maildir "/home/spam" :key ?s)))
        ...
        ,(make-mu4e-context
          ...
          :vars '((user-mail-address . "ric.lister@arcadia.com" )
                  ...
                  (mu4e-maildir-shortcuts . ((:maildir "/work/inbox" :key ?i) (:maildir "/work/spam" :key ?s)))
