...
;;       ["black" "#CD5C5C" "#548B54" "#A57706" "#21376C7" "#C61C6F" "#259286" "white"])

;; the below was cribbed from http://stackoverflow.com/questions/20952995/emacs-shell-change-directory-with-ido
;(require 'ido)
;(require 'cl-lib)
;(require 'shell)
