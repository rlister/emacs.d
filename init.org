...
#+begin_src emacs-lisp
  (dolist (name '("*Help*" "*Buffer List*" "*Bufler*"))
...
[[https://github.com/raxod502/ctrlf][Ctrlf]] is an enhanced form of isearch.
...
#+begin_src emacs-lisp
  (define-key global-map (kbd "C-c p") (lambda () (interactive) (projectile-switch-project "D")))
#+end_src
...
#+begin_src emacs-lisp
  (use-package project
    :straight t
    :config
    (add-to-list 'project-switch-commands '(?t "Vterm" projectile-run-vterm))
