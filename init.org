...
#+begin_src emacs-lisp
  (when (display-graphic-p)
    (let ((w (x-display-pixel-width)))
      (cond ((= w 1440)  (set-face-font 'default "Roboto Mono-14:foundry=GOOG"))
            ((= w 1920)  (set-face-font 'default "Roboto Mono-13:foundry=GOOG"))
            ((>= w 2560) (set-face-font 'default "Roboto Mono-11:foundry=GOOG")))))
#+end_src
...
Show isearch match count in minibuffer.
