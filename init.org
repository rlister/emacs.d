...
Bind a key for [[info:autotype#Hippie Expand][info:autotype#Hippie Expand]].
  ...
  (use-package org-agenda
    ...
    (setq org-agenda-custom-commands
          '(
            ...
            ("h" "Home tasks"
             agenda ""
             ((org-agenda-files '("~/src/doc/home.org" "~/.local/share/ric.org" "~/.local/share/listers.org"))
